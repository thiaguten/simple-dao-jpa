...
import br.com.thiaguten.persistence.spi.provider.jpa.AbstractJpaPersistenceProvider;
...
public class JpaPersistenceProviderImpl extends AbstractJpaPersistenceProvider {
  ...
  public <ID extends Serializable, T extends Persistable<ID>> List<T> findByQuery(Class<T> entityClazz, String query, Object... params) {
    return super.findByQuery(entityClazz, query, params);
  }
