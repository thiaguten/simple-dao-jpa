...
public class UserDAOImpl extends BasePersistence<Long, User> implements UserDAO {
  ...
  private final JpaPersistenceProvider persistenceProvider;

  @Autowired
  public UserDAOImpl(@Qualifier("jpaPersistenceProvider") JpaPersistenceProvider persistenceProvider) {
    this.persistenceProvider = persistenceProvider;
  }

  @Override
  public JpaPersistenceProvider getPersistenceProvider() {
  ...
  public List<User> findByName(String name) {
    ...
    List<User> results = findByQueryAndNamedParams(jpql, namedParams);
